...
//       <div className="form">
//       <h1>Add new book</h1>
//       <input type='text' placeholder= "Books name" onChange={handleChange} name='title' />
//       <input type='text' placeholder= "Desc name" onChange={handleChange} name="desc" />
//       <input type='text' placeholder= "Cover name" onChange={handleChange} name="cover" />
